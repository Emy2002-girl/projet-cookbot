document.addEventListener("DOMContentLoaded", () => {
    ...
    const dureeInput = document.getElementById("durre") // Correction de l'ID
    ...
    if (generateButton) {
      generateButton.addEventListener("click", () => {
        ...
        const goal = objectifSelect ? mapObjectifToGoal(objectifSelect.value) : "maintien"
    ...
    // Fonction pour mapper l'objectif sélectionné à la valeur attendue par l'API
    function mapObjectifToGoal(objectif) {
      switch (objectif) {
        case "petit-déjeuner": // "Manger sainement"
          return "maintien"
        case "déjeuner": // "Perdre du poids"
          return "perte_poids"
        case "dîner": // "Prendre du muscle"
          return "prise_muscle"
        default:
          return "maintien"
      }
